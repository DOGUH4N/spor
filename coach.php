...
<form>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="name" class="form-control" id="inputPassword4" placeholder="İsim-soyisim">
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="inputAddress2">Deneyim</label>
        <input type="text" name="experience" class="form-control" id="inputAddress2" placeholder="deneyim">
    </div>
